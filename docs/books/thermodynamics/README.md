...
**やる夫**：
もし同じ$T_H$と$T_C$の間で、これより効率の高い機関があったとするお。
高効率機関で仕事を得て、その一部で可逆機関を逆回転させ、低温側から高温側へ熱を戻す。
うまく組み合わせれば、外部への変化は低温側から熱を奪って正味仕事を出すだけになるお。
...
**やらない夫**：
では氷、水、水蒸気が同じ温度で共存する境界では、何が等しい？

**やる夫**：
温度と圧力が同じだけでは足りないお。
もし一方の相へ変わる方が有利なら、全部そっちへ変わる。
共存するには、相を少し移したときの熱力学的な得失が等しくないといけないお。
...
**やる夫**：
一定温度・一定圧力なら、ギブズ自由エネルギー

$$G=H-TS$$

が小さい状態が安定になるお。
1mol増やしたときの変化が化学ポテンシャル$\mu$。
液体と蒸気が共存する条件は
...
**やる夫**：
相転移は大量の熱を一定温度で受け渡せる。
でも潜熱の量、相平衡の温度、圧力、元へ戻す仕事は全部会計に入る。
相転移を利用して熱を運びやすくはできるが、第二法則を迂回はできないお。
...
**できる子**：
環境35℃、308Kとして、それぞれの理想最大仕事を計算。
電池、約1MJ。ワッシャー換算で約1000万段。
圧縮空気、ほぼ同等。
500℃の蒸気から熱1MJ、$1-308/773$で約60%、約600万段。
40℃の温水から熱1MJ、$1-308/313$で約1.6%、約16万段。

**やる夫**：
電池が1番かお！？
一番おとなしいやつが一番強いお。
500℃の蒸気ですら6割で、40℃の温水は1.6%……。
同じ1MJの札が4枚あるのに、使える金額が60倍も違うお。
...
電池と圧縮空気は、その関所を通らずに直接ワッシャーを上げられるお。
