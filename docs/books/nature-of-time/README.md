...
**やる夫**：
前の節では「隙間がない」を言葉だけで済ませてしまったお。
だから今回は、どの2つの時刻の間にも別の時刻がある、という条件にして数珠の糸を作るお。
...
**やる夫**：
前の節で、位相は時計の速さを捨てても大域的なつながり方を残すと分かったお。
それなら伸ばすだけじゃ差が見えにくいから、今度は時間軸を輪にしたお。
...
**やる夫**：
前の節で、位相だけでは過去と未来の向きを決められなかったお。
なら先に境界を置こうと思って、時間実在判定機に宇宙全体の現在を表示する機能を付けたお。
...
**やる夫**：
前の節で、宇宙共通の「今」を一意に表示する機能は壊れたお。
でも手元の時計まで無意味になったわけじゃない。
...
**やる夫**：
前の節では、ブロック宇宙なら未来も時空の一部として扱えると分かったお。
でも未来が存在するなら、やる夫の選択も全部決まってるお。
努力しても無意味だお。
...
**やる夫**：
前の節で、記録を固定するには増幅して環境へ熱を捨てる必要があると分かったお。
それなら記録が過去向きにだけ溜まる理由を、熱力学の第2法則から試すお。
...
**やる夫**：
前の節では、予測不能な古典系でも未来そのものは一本にできたお。
でも法則が結果へ確率を割り当てる量子力学なら、今度こそ枝が世界側にあるかもしれないお。
測定前は状態が重ね合わせになって、
...
**やる夫**：
前の節では、時間軸を樹にすると分岐点で通常の多様体構造が壊れたお。
なら枝の図を先に置かず、壊れにくい関係だけから時間を作り直すお。
...
**やらない夫**：
流れの実感を否定せず、物理量との混同だけ外せたな。では、動画から始まった存在の問いは。
...
**やる夫**：
前の節で、時間を一つの物質ではなく複数の構造へ分解したお。
でも最初の一日について、やる夫が本当に知りたかったことは箇条書きだけじゃ終わらない。
だからもう一度、5年前の動画を見てるお。
