...
[![｜女真《ヌジェン》から｜満洲《マンジョウ》と｜匈奴《ションヌ》からモンゴルを人・言語・政治・名前の4本の線で比較する図](figs/fig2-four-lines.svg)](figs/fig2-four-lines.svg)

図2：｜女真《ヌジェン》から｜満洲《マンジョウ》は複数の線が重なるが、｜匈奴《ションヌ》からモンゴルへ同じ太さの直系線は引けない（タップ／クリックで原寸表示）。
