...
**やらない夫**：
物質の中の電荷がどれだけ動けるかによって、導体と絶縁体の違いも生まれる。
...
**やらない夫**：
電荷を出し入れしても電位がほとんど変わらないほど巨大な導体として扱える。
それが接地だ。
...
**やらない夫**：
球以外の閉曲面でも、電場の流出量、つまり電束は内部電荷だけで決まる。
...
**できる子**：
金属板の静電容量は約 $100\,\mathrm{pF}$。
最初の1回に使った電荷は約 $1\,\mathrm{nC}$、板の間隔は $3\,\mathrm{mm}$。

**やる夫**：
コンデンサでは $Q=CV$ だから、最初は、
...
**やらない夫**：
電子密度を $n$、電子1個の電荷の大きさを $e$、導線の断面積を $A$、平均ドリフト速度を $v_d$ とすると、
...
**やらない夫**：
時間変化する磁場がある場合、閉じた経路に沿う電場の積分は0にならない。
そのとき単純な電圧則は修正が必要になる。
...
**やらない夫**：
少なくとも現在まで、孤立した磁気単極子は通常の電磁気現象では観測されていない。
磁力線はN極から出てS極へ入り、磁石内部を通って閉じる。

**やる夫**：
電気力線は正電荷から始まり負電荷で終われるが、磁力線は必ず閉ループ。
閉曲面を貫く磁束の合計は0。
...
**やる夫**：
1立方メートルあたりの流出量……その点で場がどれだけ湧き出しているか、という密度だお。
...
外積といい、$\mathbf a\times\mathbf b$ と書く。
...
質量分析で粒子を分けたり、加速器で粒子の軌道を曲げたりできるお。
...
**やらない夫**：
電磁場のエネルギー流密度は、ポインティングベクトルで表される。
